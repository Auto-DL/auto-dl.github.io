                        ...
                        <div className="container-fluid">
                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul className="navbar-nav mb-2 mb-lg-0">
                                    ...
                                    <li className="nav-item"><Link className="nav-link" to="/contact">Pricing</Link></li>
                                </ul>
                                <ul className="navbar-nav mb-2 mb-lg-0">
                                    <li className="nav-item"><Link className="nav-link" to="/">Support</Link></li>
                                    <li className="nav-item"><Link className="nav-link" to="/demo">Blog</Link></li>
                                    <li className="nav-item"><Link className="nav-link" to="/about">Docs</Link></li>
                                    <li className="nav-item"><Link className="nav-link" to="/features">WHats new</Link></li>
                                    <li className="nav-item"><a className="nav-link" href="https://autodl.slack.com/join/shared_invite/zt-qagxiwub-ywRM_oBvvF~F7YNtlBqy_Q#/shared-invite/email">
                                        <i className="fab fa-slack"></i></a></li>
                                    <li className="nav-item"><a className="nav-link" href="https://github.com/Auto-DL/ ">
